...
public class StudyplanAdapterFactory extends AdapterFactoryImpl {
	...
	protected StudyplanSwitch<Adapter> modelSwitch =
		new StudyplanSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSelectiveCourse(SelectiveCourse object) {
				return createSelectiveCourseAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link tdt4250.studyplan.Program <em>Program</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link tdt4250.studyplan.SelectiveCourse <em>Selective Course</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSelectiveCourseAdapter() {
		return null;
	}
